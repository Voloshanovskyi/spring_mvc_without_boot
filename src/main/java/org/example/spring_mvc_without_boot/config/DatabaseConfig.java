...
@Configuration
@EnableJpaRepositories(basePackages = "org.example.spring_mvc_without_boot.repository")
...
public class DatabaseConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        entityManagerFactoryBean.setPackagesToScan("org.example.spring_mvc_without_boot.entity");
